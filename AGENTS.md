...
*   **Manual Upload**: Zip the contents of the `tps` output folder and upload the `.zip` file via `Configure → Interface` (the **Custom Interface** tab) in the Management interface.
